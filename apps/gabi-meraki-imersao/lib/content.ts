...
export const techniques = {
  ...
  items: [
    ...
    { name: "Aplicação orientada", description: "Passo a passo de onde e como aplicar cada elemento." },
  ],
};

export const ovenSection = {
  title: "Forno profissional? Você não precisa de um.",
  intro: "O queimação funciona com o que você já tem em casa:",
  options: ["Forno a gás", "Forno elétrico", "Air fryer"],
  note: "Você vai aprender temperatura, tempo e os erros mais comuns pra não perder a peça na queima.",
};

export const howItWorks = {
  title: "Como funciona o evento na prática",
  specs: [
    { label: "Formato", value: "Online" },
    { label: "Duração", value: "5 dias consecutivos" },
    { label: "Horário", value: "7h (horário de Brasília)" },
  ],
  classesNote: "Aulas práticas, organizadas, objetivas — pensadas pra quem nunca pintou porcelana.",
  format: {
    title: "Formato das aulas",
    items: ["Retransmissão ao vivo", "Gravações disponíveis por 7 dias"],
  },
  support: {
    title: "Suporte",
    text: "Você não vai ficar sozinha no processo.",
  },
};
...
export const materials = {
  ...
  items: [
    "Bandeja retangular de porcelana",
    "Decalque de flores",
    "Caneta Faber-Castell cor Ouro",
    "Papel carbono",
    "Papel vegetal",
  ],
};
...
export const checklist = {
  ...
  items: [
    "Acesso ao evento online por 5 dias",
    "Aulas práticas e objetivas",
    "Materiais enviados pra sua casa",
    "Frete grátis pra todo o Brasil",
    "Gravações disponíveis por 7 dias",
    "Suporte pra tirar dúvidas",
    "Execução guiada da sua primeira peça",
  ],
};
...
export const benefits = {
  ...
  items: [
    "Preparar sua primeira peça do zero",
    "Aplicar um desenho mesmo sem saber desenhar",
    "Pintar com segurança, sem medo de errar",
    "Aprender a queimação segura em forno comum",
    "Finalizar a peça no forno comum ou na air fryer",
    "Entender os cuidados essenciais da porcelana",
    "Ganhar confiança pra continuar pintando depois do evento",
  ],
};
...
export const supportSection = {
  ...
  text: "Fala com a nossa equipe antes de decidir.",
};
